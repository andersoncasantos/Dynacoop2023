...
namespace Marketplace.AlfaPeople.ConsoleApplication.Model
{
    public class Conta
    {
        ...
        public void IncrementOrDecrementValueOfOpp(Entity oppAccount, bool? decrementOrIncrement)
        {
            int valueOfOpp = oppAccount.Contains("mtv_total_opp") ? (int)oppAccount["mtv_total_opp"] : 0;
            ...
            oppAccount["mtv_total_opp"] = valueOfOpp;
